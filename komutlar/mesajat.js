...
exports.run = (client, message, args) => {
  if (message.author.id != "741321235400622180") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  if (reason.length < 1) return message.reply('Ne göndermem gerektiğini yazmalısın.');
