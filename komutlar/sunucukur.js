...
exports.run = (client, message, args) => {
  ...
  return message.channel.send(" Yetkin bulunmuyor.");
    message.channel.send(new Discord.RichEmbed().setColor('RANDOM').setTitle('Komut giriişi').setDescription('Gerekli Dosaylar Kurulsun mu?.').setFooter('Bu eylemi onaylıyorsan "evet" yazman yeterlidir.Bu eylem 30 saniye içinde sona erecek'))
.then(() => {
...
exports.help = {
  name: 'sunucukur',
  description: 'Bot İçin gerekli kanlaları kurar.',
  usage: 'sb?kurulum'
};
