...
exports.run = async (client, message) => {
  ...
  if (secenekler !== "aç" && secenekler !== "kapat" && secenekler !== "on" && secenekler !== "off") return message.reply("**Açmak İstiyorsan:**```sb?linkengelle aç``` **Kapatmak İstiyorsan:**```sb?linkengelle kapat``` **yaz!**")
